<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="Yann Olivier" class="img-circle profile-img">
                                <h6 class="title">Yann Olivier</h6>
                                <small class="info">Beginner Developer</small>
                            </div>
                            <!-- /.user-info -->

                            <div class="sidebar-nav">
                                <ul class="side-nav color-danger">
                                    <li class="nav-header">
