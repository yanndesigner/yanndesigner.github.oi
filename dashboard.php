...
<html lang="en">
    <head>
        ...
        <title> My Class (Student Result Management System) | Dashboard</title>
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title">My Class System</h2>
...
?>
                                            ...
                                            <span class="name">  Overall classes listed</span>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat bg-danger" href="manage-results.php">
                                        <?php 
